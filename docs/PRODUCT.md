...
Ai Os Fluid Interface Design is a focused, shareable agent workflow.

## What it does

Use when building or reviewing AI-OS, Hermes, dashboard, desktop, phone/PWA, chat, sheet, drawer, gesture, motion, or streaming-state interfaces. Apply fluid, responsive, interruptible behavior with accessibility and deterministic verification. Use when the user explicitly requests this capability or a closely related task.
