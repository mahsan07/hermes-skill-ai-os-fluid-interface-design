...
![Step-by-step workflow for AI-OS Fluid Interface Design](../assets/workflow.svg)
...
![Safety and approval boundaries for AI-OS Fluid Interface Design](../assets/safety-boundary.svg)
