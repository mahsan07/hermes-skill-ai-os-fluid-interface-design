<p align="center">
  <img src="assets/system-map.svg" alt="Detailed system map for AI-OS Fluid Interface Design" width="100%">
</p>

# AI-OS Fluid Interface Design

> Building or reviewing AI-OS, Hermes, dashboard, desktop, phone/PWA, chat, sheet, drawer, gesture, motion, or streaming-state interfaces. Apply fluid, responsive, interruptible behavior with accessibility and deterministic verification.
...
Agent work becomes unreliable when scope, handoffs, approval boundaries, and proof of completion remain implicit. **AI-OS Fluid Interface Design** turns that work into an explicit sequence with visible inputs, outputs, review points, and completion evidence.

## Why the repository has this name

The shared `hermes-skill-` prefix identifies this as a portable Hermes workflow package. `ai-os-fluid-interface-design` names the capability directly—ai os fluid interface design—so the repository remains searchable and understandable outside the original AI-OS workspace. The public title is **AI-OS Fluid Interface Design**.
...
| What does it do? | Building or reviewing AI-OS, Hermes, dashboard, desktop, phone/PWA, chat, sheet, drawer, gesture, motion, or streaming-state interfaces. Apply fluid, responsive, interruptible behavior with accessibility and deterministic verification. |
...
![AI-OS Fluid Interface Design system map](assets/system-map.svg)

## Operation sequence

![AI-OS Fluid Interface Design actor and data sequence](assets/operation-sequence.svg)
...
![Illustrative output produced by AI-OS Fluid Interface Design](assets/example-output.svg)
...
![Decision guide for AI-OS Fluid Interface Design](assets/decision-guide.svg)
...
> For a bounded, reversible task, building or reviewing AI-OS, Hermes, dashboard, desktop, phone/PWA, chat, sheet, drawer, gesture, motion, or streaming-state interfaces. Apply fluid, responsive, interruptible behavior with accessibility and deterministic verification. Return the result, the evidence used to verify it, and any limitations or actions that still require approval.
